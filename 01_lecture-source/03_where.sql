...
-- 메뉴 테이블에서 모든 컬럼조회
-- 가격이 10000원 이상 20000원 미만 인 메뉴를 조회해줘
...
-- and 는 둘 중 하나라도 true 값이 아니면 false 다
-- or 둘 중 하나라도 true 면 true

-- between : ~ 사이
-- between a and b
-- 메뉴테이블에서 모든 컬럼 조회
-- 단, 메뉴가격이 10000과 20000원 사이 인 메뉴만 조회  
...
-- 메뉴테이블에서 모든 컬럼 조회
-- 단, 메뉴가격이 10000과 20000원 사이가 아닌 메뉴만 정의
-- 부정의 키워드 not
...
-- 메뉴 테이블에서 전체 컬럼 조회
-- 단, 가격이 5000원 넘으면 카테고리 코드가 10이면서 '갈치'단어를 포함하는 메뉴조회
